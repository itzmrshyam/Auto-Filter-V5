...
API_ID = int(environ.get('API_ID', '10849399'))
API_HASH = environ.get('API_HASH', 'c472b03d620f9775720fd240cb4e8584)
BOT_TOKEN = environ.get('BOT_TOKEN', "5606104134:AAHSTP_Agy2DKjbs64_fc0Q2DkgbQvr3AiU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '10849399').split()]
